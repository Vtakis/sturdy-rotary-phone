...
Στο πρώτο κομμάτι δεν είχαμε κάποιο dataset γιαυτό και δεν έχουμε μετρήσεις.Στο unit testing κάναμε δικές μας δοκιμές χωρίς να χρησιμοποιούμε κάποιο framework.
...
Όσων αφορά το τρίτο μέρος ,τα μέρη που μας απασχόλησαν κυρίως, ήταν η δημιουργία στατιστικών για την εύρεση της βέλτιστης σειράς εκτέλεσης των join καθώς και η δημιουργία και εκτέλεση των νημάτων.Παρακάτω βρίσκεται η επεξήγησή τους.
...
|	| Part 2 small  | Part 3 small  |  Part 2 public | Part 3 public  |
| ----- |:-------------:|:-------------:|:--------------:|:--------------:|
| Time	| 2.6s          |    0.53s      |     2m8s       |	28s       |

Σχόλιο:
> Τέλος παρατηρούμε οτι η διαφορά χρόνου απο το 2ο part είναι αρκετά μεγάλη και για τα 2 datasets (small,public) και αυτό οφείλεται στις αλλαγές που έγιναν πάνω στα στατιστικά και κατα συνέπεια στην εγαρμογή του αλγορίθμου εύρεσης της καλύτερης σειράς εκτέλεσης των κατηγωρημάτων και στην εφαρμογή των νημάτων.

|			| Small         | Public        |
| ----------------------|:-------------:|:-------------:|
| Ποσοστό μείωσης	| 490%          |    450%       |

Παρατήρηση:
> Βλέπουμε ότι τα ποσοστά είναι τεράστια ,πράγμα που σημαίνει οτι ο σκοπός μας για το 3o part επιτεύχθηκε με απόλυτη επιτυχία!
